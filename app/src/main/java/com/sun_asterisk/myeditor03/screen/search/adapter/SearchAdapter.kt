...
class SearchAdapter : BaseAdapter<Search>() {
    ...
    companion object {
        class SearchAdapterViewHolder(
            private val view: View, private var onItemClickListener: OnItemClickListener
            ...
            override fun bindData(data: Search, listener: OnItemRecyclerViewClickListener<Search>) {
                ...
                view.imageViewRemoveHistory.setOnClickListener { onItemClickListener.onItemClickListener(data) }
            }
        }
    }
}
